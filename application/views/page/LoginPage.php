...
<head>
    ...
    <script>
        ...
        style.innerHTML = 'body { text-size-adjust: 100%; }';
        style.innerHTML = '.swal2-icon { user-select: none; -webkit-user-select: none; }';
...
<body>
    <div class="auth-container">
        <div class="col-0 col-md-6 col-xl-7 img-wrapper">
            <img class="img-wallpaper" src="https://jesuits.id/wp-content/uploads/2024/09/FRA4837-2048x1366.jpg" alt="Login Wallpaper">
        </div>
        <div class="col-12 col-md-6 col-xl-5 login-card px-5 d-flex flex-column justify-content-center">
            <form class="position-relative px-1 px-md-5" method="post">
                <div class="d-flex flex-column flex-md-row login-header position-absolute">
                    <img class="img-logo" src="<?= base_url("assets/images/logo-ihs-new.png") ?>" alt="LOGO SJ" />
                </div>
