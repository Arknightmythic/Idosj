...
<body>
    ...
    <div class="container px-4 px-md-0">
        ...
        <section>
            ...
            <div class="table-responsive">
                <table class="dataless">
                    ...
                    <tr>
                        <td>Status</td>
                        <td><?= $dataPribadi->statusMeninggal != NULL ? $dataPribadi->statusMeninggal ? "Passed Away" : "Alive" : "-" ?>
                        </td>
                    </tr>
                </table>
            </div>
                    ...
                    <tbody>
                        <?php if (count($dataPendidikan) > 0) : foreach ($dataPendidikan as $pendidikan) : ?>
                                <tr>
                                    ...
                                    <?php if ($editStatus) : ?>
                                        <td>
                                            <button class="btn btn-danger btn-sm hapusPendidikan" onclick="hapusPendidikan(<?= $pendidikan->id ?>)">
                                                <i class="fa fa-trash"></i>
                                            </button>
                                            <button class="btn btn-primary btn-sm editPendidikan" onclick="editPendidikan(<?= $pendidikan->id ?>)">
                    ...
                    <tbody>
                        <?php if (count($dataSakramen) > 0) : foreach ($dataSakramen as $sakramen) : ?>
                                <tr>
                                    ...
                                    <?php if ($editStatus) : ?>
                                        <td>
                                            <button class="btn btn-danger btn-sm hapusSakramen" onclick="hapusSakramen(<?= $sakramen->id ?>)">
                                                <i class="fa fa-trash"></i>
                                            </button>
                                            <button class="btn btn-primary btn-sm editSakramen" onclick="editSakramen(<?= $sakramen->id ?>)">
                                                <i class="fa fa-pencil"></i>
                                            </button>
                                        </td>
                                    <?php endif; ?>
                    ...
                    <tbody>
                        <?php if (count($dataDokumen) > 0) : foreach ($dataDokumen as $dokumen) : ?>
                                <tr>
                                    ...
                                    <?php if ($editStatus) : ?>
                                        <td>
                                            <button class="btn btn-danger btn-sm hapusDokumen" onclick="hapusDokumen(<?= $dokumen->id ?>)">
                                                <i class="fa fa-trash"></i>
                                            </button>
                                            <button class="btn btn-primary btn-sm editDokumen" onclick="editDokumen(<?= $dokumen->id ?>)">
                                                <i class="fa fa-pencil"></i>
                                            </button>
                                        </td>
                                    <?php endif; ?>
        ...
        <section class="d-flex justify-content-end">
            <?php if ($editStatus) : ?>
                <a href="<?= base_url("/anggota/pribadi/$dataPribadi->id") ?>"><button class="btn btn-success px-5 btn-lg">Selesai</button></a>
            <?php else : ?>
                <a href="<?= base_url("/anggota/pribadi/$dataPribadi->id?edit=true") ?>"><button class="btn btn-primary px-5 btn-lg">Edit</button></a>
            <?php endif; ?>
        </section>
    </div>
    <?= $footer ?>
