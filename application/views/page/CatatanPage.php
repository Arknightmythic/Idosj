...
<body>
    ...
    <div class="container px-4 px-md-0">
        ...
        <section>
            ...
            <div class="table-responsive">
                <table class="table table-stiped">
                    <thead>
                        <th class="col-2">Surat Permohonan</th>
                        <th class="col-2">Surat Provinsial</th>
                        <th class="col-2">Judgement of Provinsial</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <td>
                                <?php if(!empty($value)): ?>
                                <a class="btn btn-primary" href="<?= base_url("/uploads/catatan/").$value?>"
            ...
            <div class="table-responsive">
                <table class="table table-stiped">
                    <thead>
                        ...
                        <th>Surat Provinsial</th>
                        <th>CV dan Wawancara</th>
                        <th>Judgement of Provinsial</th>
                        <th>Testimony</th>
                        <th>Surat Pater Jenderal</th>
                        <th class="col-2">Surat Dispensasi Vatikan</th>
                    <tbody>
                        <tr>
                            <?php
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-primary"
                                    href="<?= base_url("/uploads/catatan/").$dataKematian->aktaKematian?>"
                                    target="_blank"><i class="fa fa-file-lines"></i></a>
                                <?php else: ?>
                                -
                                <?php endif; ?>
                            ...
                            <td>
                                ...
                                <a class="btn btn-primary"
                                    href="<?= base_url("/uploads/catatan/").$dataKematian->keteranganKematian?>"
                                    target="_blank"><i class="fa fa-file-lines"></i></a>
                                <?php else: ?>
                                -
                                <?php endif; ?>
        ...
        <section class="d-flex justify-content-end">
            <?php if($editStatus): ?>
            <a href="<?= base_url("/anggota/catatan/$dataPribadi->id") ?>"><button
                    class="btn btn-success px-5 btn-lg">Selesai</button></a>
            <?php else: ?>
            <a href="<?= base_url("/anggota/catatan/$dataPribadi->id?edit=true") ?>"><button
